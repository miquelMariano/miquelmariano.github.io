...
VSphere HA permite a un administrador del servidor agrupar servidores físicos en la misma red en un grupo lógico llamado clúster de alta disponibilidad  . Durante una falla del servidor, como un bloqueo del sistema, interrupción de energía o falla de la red, vSphere HA detecta qué máquinas virtuales están inactivas y las reinicia en otro sistema estable dentro del clúster. Este proceso de reinicio de cargas de trabajo fallidas en sistemas secundarios se denomina  conmutación por error .

VMware introdujo por primera vez vSphere HA en Virtual Infrastructure 3 en 2006 y ha seguido desarrollando y admitiendo la característica.

Usado generalmente, la  alta disponibilidad  es un término usado para describir sistemas o aplicaciones que están disponibles, funcionando como se espera, un alto porcentaje del tiempo. En los centros de datos empresariales, la disponibilidad del sistema a menudo supera el 99% y, a menudo, se mide en  nueves .
