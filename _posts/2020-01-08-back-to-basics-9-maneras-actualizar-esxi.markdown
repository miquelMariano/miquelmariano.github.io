...
Buenos días a tod@s. Vamos a empezar el año continuando con la serie [back-to-basics](https://miquelmariano.github.io/tags/#/backtobasics).
...
En [este post](https://miquelmariano.github.io/automate-config-ESXi/) que escribí hace tiempo está el paso a paso de todo el proceso.
...
Para actualizar a versiones superiores (de 6.5 a 6.7 por ejemplo) Teneis [este post](https://miquelmariano.github.io/update-esxi-offline-bundle/) en dónde se explica los pasos a seguir

#### Actualización de parches ESXi

En caso de ya estar en versión 6.7 y sólo querer actualizar los nuevos parches, cómo por ejemplo instalar el último U3, podremos seguir [el siguiente post](https://miquelmariano.github.io/actualizacion-esxi-sin-update-manager/)
...
En [este post](https://miquelmariano.github.io/autodeploy/) publiqué hace ya tiempo información bastante extendida de cómo implementar y configurar Auto Deploy en entornos vSphere 6.x

### Rollback

Para finalizar, os dejo también el [enlace a un post](https://miquelmariano.github.io/esxi-rollback/) en dónde explicaba cómo hacer rollback de un servidor ESXi.
