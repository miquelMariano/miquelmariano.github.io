...
Parece que era ayer cuando escribia mi [primera entrada](https://miquelmariano.github.io/hello-world/) en este blog, y ya han pasado 365 días!!!
...
1. [Notificaciones automáticas con Telegram](https://miquelmariano.github.io/notificaciones-automaticas-con-telegram/)
2. [Configuración de Windows para ser manejado con Ansible](https://miquelmariano.github.io/ansible-windows-managed-nodes/)
3. [¿Como se usan los roles y playbooks en Ansible?](https://miquelmariano.github.io/roles-y-playbooks-Ansible/)
4. [Programar export automático de RVTools](https://miquelmariano.github.io/programar-export-rvtools/)
5. [Programar backup automático en VCSA 6.5](https://miquelmariano.github.io/backup-vcsa65-automatizado/)
