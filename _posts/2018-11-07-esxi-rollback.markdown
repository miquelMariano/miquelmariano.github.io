...
También es recomendable, antes de hacer cualquier actuación sobre un ESXi, tener un [backup](https://miquelmariano.github.io/backup-restore-esxi-configuration/) consistente del mismo.
